...
SELECT 'WWI-mirror' AS [SourceSystemName],
    ...
    'WideWorldImporters-mirror.Application.PaymentMethods' AS [DestinationRawTable],
    1 AS [ActiveFlag],
...
SELECT 'WWI-mirror' AS [SourceSystemName],
    ...
    NULL AS [LastDeltaDate],
    NULL AS [MaxIntervalMinutes],
    'WideWorldImporters-mirror.Application.People' AS [DestinationRawTable],
    1 AS [ActiveFlag],
    1 AS [L1TransformationReqdFlag],
    0 AS [L2TransformationReqdFlag],
    0 AS [DelayL1TransformationFlag],
...
SELECT 'WWI-mirror' AS [SourceSystemName],
    ...
    NULL AS [LastDeltaDate],
    NULL AS [MaxIntervalMinutes],
    'WideWorldImporters-mirror.Application.TransactionTypes' AS [DestinationRawTable],
    1 AS [ActiveFlag],
    1 AS [L1TransformationReqdFlag],
    0 AS [L2TransformationReqdFlag],
    0 AS [DelayL1TransformationFlag],
...
SELECT 'WWI-mirror' AS [SourceSystemName],
    ...
    'WideWorldImporters-mirror.Purchasing.PurchaseOrders' AS [DestinationRawTable],
    1 AS [ActiveFlag],
    1 AS [L1TransformationReqdFlag],
...
SELECT 'WWI-mirror' AS [SourceSystemName],
    ...
    '2013-01-07' AS [LastDeltaDate],
     1440 AS [MaxIntervalMinutes], --1 day interval
    'WideWorldImporters-mirror.Purchasing.SupplierTransactions' AS [DestinationRawTable],
    1 AS [ActiveFlag],
    1 AS [L1TransformationReqdFlag],
    1 AS [L2TransformationReqdFlag],
    0 AS [DelayL1TransformationFlag],
...
SELECT 'WWI-mirror' AS [SourceSystemName],
    ...
    '2013-01-02' AS [LastDeltaDate],
     1440 AS [MaxIntervalMinutes], --1 day interval
    'WideWorldImporters-mirror.Sales.CustomerTransactions' AS [DestinationRawTable],
    1 AS [ActiveFlag],
    1 AS [L1TransformationReqdFlag],
    1 AS [L2TransformationReqdFlag],
    0 AS [DelayL1TransformationFlag],
...
SELECT 'WWI-mirror' AS [SourceSystemName],
    ...
    '2013-01-01' AS [LastDeltaDate],
     1440 AS [MaxIntervalMinutes], --1 day interval
    'WideWorldImporters-mirror.Sales.Orders' AS [DestinationRawTable],
    1 AS [ActiveFlag],
    1 AS [L1TransformationReqdFlag],
    1 AS [L2TransformationReqdFlag],
    0 AS [DelayL1TransformationFlag],
